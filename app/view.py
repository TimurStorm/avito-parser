...
from .models import Ad, Avito_parser
...
def write_parser(parser: Avito_parser):
    with open('csv/parsers.csv', 'a', encoding="utf-8") as file:
        writer = csv.writer(file, delimiter=",")
        writer.writerow(parser.title, parser.url, parser.time)
